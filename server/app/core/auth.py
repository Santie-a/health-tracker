...
Single-user gateway. If the token is unset the check is skipped (dev only);
the service is expected to stay on the LAN/VPN regardless. Mirrors image-svc.
"""
...
_bearer = HTTPBearer(auto_error=False, description="Shared gateway token (no 'Bearer ' prefix).")
